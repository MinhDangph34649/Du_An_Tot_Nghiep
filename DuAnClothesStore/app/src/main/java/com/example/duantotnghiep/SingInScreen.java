                    ...
                    mAuth.signInWithEmailAndPassword(email, password)
                            .addOnCompleteListener(SingInScreen.this, task -> {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(SingInScreen.this, "Đăng nhập thành công ", Toast.LENGTH_SHORT).show();
                                    // startActivity(new Intent(SingInScreen.this, HomeActivity.class));
                                    // finish();
                                } else {
                                    // Đăng nhập thất bại
                                    Toast.makeText(SingInScreen.this, "Đăng nhập thất bại: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
